...
macro (installAndExportLib libName)
    ...
    install(TARGETS ${libName}
        RUNTIME DESTINATION ${SAFAGA_INTERNAL_PACKAGE_DIRECTORY}/bin/${TARGET_ARCH}
        LIBRARY DESTINATION ${SAFAGA_INTERNAL_PACKAGE_DIRECTORY}/lib/${TARGET_ARCH}
        ARCHIVE DESTINATION ${SAFAGA_INTERNAL_PACKAGE_DIRECTORY}/lib/${TARGET_ARCH}
    	)
